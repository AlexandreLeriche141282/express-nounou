    ...
    <section className={styles.aPropos} id="a-propos">
      <div className={styles.container}>
        ...
        <div className={styles.textContainer}>
          <h1>Garde d'enfants d'urgence <br /><span>votre solution rapide pour des moments imprévus !</span></h1>
          <p>
            ...
            Je vous propose mes services de remplacement d'urgence pour les entreprises sap et les particuliers employeurs.
          </p>
          {/* <p>
